...
public class RmRawTransaction {
    ...
    public static RmRawTransaction createContractTransaction(
            BigInteger nonce,
            BigInteger gasPrice,
            BigInteger gasLimit,
            BigInteger value,
        ...
        return new RmRawTransaction(nonce, gasPrice, gasLimit, "", value, init);
    }

    public static RmRawTransaction createEtherTransaction(
            BigInteger nonce,
            BigInteger gasPrice,
            BigInteger gasLimit,
            String to,
        ...
        return new RmRawTransaction(nonce, gasPrice, gasLimit, to, value, "");
    }
    ...
    public static RmRawTransaction createEtherTransaction(
            ...
            BigInteger gasPremium,
            BigInteger feeCap) {
        return new RmRawTransaction(nonce, null, gasLimit, to, value, "", gasPremium, feeCap);
    }

    public static RmRawTransaction createTransaction(
    ...
    public static RmRawTransaction createTransaction(
        ...
        return new RmRawTransaction(nonce, gasPrice, gasLimit, to, value, data);
    }
    ...
    public static RmRawTransaction createTransaction(
        ...
        return new RmRawTransaction(nonce, gasPrice, gasLimit, to, value, data, gasPremium, feeCap);
    }
